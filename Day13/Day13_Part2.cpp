...
int main() {
  ...
  while(scanf("%s would %s %d happiness units by sitting next to %s.", currPersonTmp, gain_loseTmp, &value, nextToPersonTmp) != EOF) {
    ...
    // Part 2:
    string me = "me";
    happinessTable[me][currPerson] = 0;
    happinessTable[currPerson][me] = 0;
  }
            ...
            for(string seat6 : namesM5) {
              ...
              for(string seat7 : namesM6) {
                ...
                for(string seat8 : namesM7) {
                  vector<string> namesM8 = getRemainingNames(namesM7, seat8);
                  for(string seat9 : namesM8) {
                    vector<string> combo;
                    ...
                    //string combination = seat1 + " " + seat2 + " " + seat3 + " " + seat4 + " " + seat5 + " " + seat6 + " " + seat7 + " " + seat8 + " " + seat9;
